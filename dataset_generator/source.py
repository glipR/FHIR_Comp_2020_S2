...
NUMBER_OF_PATIENTS = int(4e5)
PRACTITIONERS_PER_ORGANIZATION = [10, 20]
PRACTITIONERS_PER_PATIENT = [1, 5]
...
WeightedRandom.ALL_ORGS = generate_organizations(NUMBER_OF_ORGANIZATIONS, API_URL, API_TOKEN, dataset_path)

from .practitioners import generate_practitioners
WeightedRandom.ALL_PRACS = generate_practitioners(NUMBER_OF_PRACTITIONERS, PRACTITIONERS_PER_ORGANIZATION, API_URL, API_TOKEN, dataset_path)

from .patients import generate_patients
generate_patients(NUMBER_OF_PATIENTS, PRACTITIONERS_PER_PATIENT, API_URL, API_TOKEN, dataset_path)
