...
base_url = str('https://syntheticmass.mitre.org/v1/fhir/{}}?_count=1000&apikey=b6ai0PI8aEEGrUGnMA18zAZsfqaBbFdD'.format(what_to_count))
...
page_token = None
while True:
    url = base_url + '&_page_token=' + page_token if page_token is not None else base_url
